...
//        let JSONPath = Bundle.main.path(forResource: "Rooster_Ani_ske", ofType: "json")!
//        print("JSONPath \(JSONPath)")
//        let loader = EDArmatureLoader(filePath: JSONPath)
//        print("loader \(loader)")
//        let node = loader.loadNode(named: "Rooster_Ani")
//        print("node \(node)")
//        node.repeatAnimation("rooster_run_anim")
//        node.position = CGPoint(x: -300, y: -50)
//        self.addChild(node)

        let JSONPath = Bundle.main.path(forResource: "MasBe_ske", ofType: "json")!
        print("JSONPath \(JSONPath)")
        let loader = EDArmatureLoader(filePath: JSONPath)
        print("loader \(loader)")
        let node = loader.loadNode(named: "Armature")
        print("node \(node)")
        node.repeatAnimation("geleng")
        node.position = CGPoint(x: -200, y: -500)
        self.addChild(node)
